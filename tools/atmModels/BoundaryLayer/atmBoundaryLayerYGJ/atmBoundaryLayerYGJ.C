...
const Foam::scalar Foam::atmBoundaryLayerYGJ::kappaDefault_ = 0.41;

const Foam::scalar Foam::atmBoundaryLayerYGJ::CmuDefault_ = 0.09;

const Foam::scalar Foam::atmBoundaryLayerYGJ::C1Default_ = 0.0;

const Foam::scalar Foam::atmBoundaryLayerYGJ::C2Default_ = 1.0;

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

void Foam::atmBoundaryLayerYGJ::init()
{
...
Foam::atmBoundaryLayerYGJ::atmBoundaryLayerYGJ()
:
    flowDir_(Zero),
    zDir_(Zero),
    kappa_(0.41),
...
Foam::atmBoundaryLayerYGJ::atmBoundaryLayerYGJ(const atmBoundaryLayerYGJ& abl)
:
    flowDir_(abl.flowDir_),
    zDir_(abl.zDir_),
    kappa_(abl.kappa_),
...
void Foam::atmBoundaryLayerYGJ::autoMap(const fvPatchFieldMapper& m)
{
    m(z0_, z0_);
    m(zGround_, zGround_);
    m(Ustar_, Ustar_);
...
void Foam::atmBoundaryLayerYGJ::rmap
(
    const atmBoundaryLayerYGJ& blptf,
...
Foam::tmp<Foam::vectorField> Foam::atmBoundaryLayerYGJ::U
(
    const vectorField& p
) const
{
...
Foam::tmp<Foam::scalarField> Foam::atmBoundaryLayerYGJ::k
(
    const vectorField& p
) const
{
...
Foam::tmp<Foam::scalarField> Foam::atmBoundaryLayerYGJ::epsilon
(
    const vectorField& p
) const
{
...
void Foam::atmBoundaryLayerYGJ::write(Ostream& os) const
{
