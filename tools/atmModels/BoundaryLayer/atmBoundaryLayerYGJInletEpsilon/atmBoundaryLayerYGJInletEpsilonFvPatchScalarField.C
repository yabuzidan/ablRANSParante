...
#include "atmBoundaryLayerYGJInletEpsilonFvPatchScalarField.H"
...
atmBoundaryLayerYGJInletEpsilonFvPatchScalarField
(
    const atmBoundaryLayerYGJInletEpsilonFvPatchScalarField& psf,
    const fvPatch& p,
    const DimensionedField<scalar, volMesh>& iF,
...
void atmBoundaryLayerYGJInletEpsilonFvPatchScalarField::autoMap
(
...
void atmBoundaryLayerYGJInletEpsilonFvPatchScalarField::rmap
(
...
)
{
    ...
    const atmBoundaryLayerYGJInletEpsilonFvPatchScalarField& blpsf =
        refCast<const atmBoundaryLayerYGJInletEpsilonFvPatchScalarField>(psf);

    atmBoundaryLayerYGJ::rmap(blpsf, addr);
}


void atmBoundaryLayerYGJInletEpsilonFvPatchScalarField::write(Ostream& os) const
{
